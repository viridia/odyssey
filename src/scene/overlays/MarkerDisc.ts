...
import { MarkerDiscMaterial } from './MarkerDiscMaterial';
 ...
 */
export class MarkerDisc {
  private material: MarkerDiscMaterial;
  private material2: MarkerDiscMaterial;
  ...
  constructor(parent: Object3D, options: IOptions) {
    ...
    this.material = new MarkerDiscMaterial();
    ...
    this.material2 = new MarkerDiscMaterial();
